...
$string['extracttermcode'] = 'Term code extraction pattern';
$string['extracttermcode_desc'] = 'Optional regular expression used to extract the term code from the course idnumber. The first capture group populates [TERMCODE] in the template shortname format. Leave empty to disable term-based template matching. Example: /^([^.]+)/ extracts "CMTY104" from "CMTY104.128805".';
